...
it("Chia TestStreamable - test_basic", () => {
    var a = new TestClass();
    a.a = 24;
    a.b = 352;
    a.c = [1, 2, 4];
...
it("Chia TestStreamable - test_variablesize", () => {
...
it("Chia TestStreamable - test_ambiguous_deserialization_optionals", () => {
...
it("Chia TestStreamable - test_ambiguous_deserialization_int", () => {
...
it("Chia TestStreamable - test_ambiguous_deserialization_list", () => {
...
it("Chia TestStreamable - test_ambiguous_deserialization_tuple", () => {
    const s1: bytes = Buffer.from([0, 0, 100, 24]);
...
it("Chia TestStreamable - test_ambiguous_deserialization_str", () => {
...
it("Chia TestStreamable - test_ambiguous_deserialization_bytes", () => {
    const s1: bytes = Buffer.from([0, 0, 100, 24, 52]);
...
it("Chia TestStreamable - test_ambiguous_deserialization_bool", () => {
    const s1: bytes = Buffer.from([]);
...
it("Chia TestStreamable - test_ambiguous_deserialization_program", () => {
...
it("Chia TestStreamable - test_parse_bool", () => {
    assert.isTrue(
...
it("Chia TestStreamable - test_uint32", () => {
    assert.equal(
...
it("Chia TestStreamable - test_parse_optional", () => {
    assert.isNull(
...
it("Chia TestStreamable - test_parse_bytes", () => {
    assert.equal(
...
it("Chia TestStreamable - test_parse_list", () => {
    assert.equal(
...
it("Chia TestStreamable - test_parse_tuple", () => {
    assert.equal(
...
it("Chia TestStreamable - test_parse_str", () => {
    assert.equal(
